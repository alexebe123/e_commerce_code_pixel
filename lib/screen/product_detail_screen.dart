...
class _ProductDetailScreenState extends State<ProductDetailScreen>
                    ...
                    SizedBox(
                      child: Row(
                        ...
                        children: [
                          ...
                          deliveryInformationWidget(wilayas, communes),
  ...
  Container deliveryInformationWidget(
    List<String> wilayas,
                      ...
                      border: Border.all(
                        color:
                            _selectedColor == color['name']
                                ...
                                : Colors.grey[300]!,
                        width: _selectedColor == color['name'] ? 1.5 : 1,
                      ),
                    ),
                    child: Row(
                      children: [
  ...
  Column cercelWidget(BuildContext context) {
    return Column(
      children: [
        SizedBox(
          width: 300,
              ...
              Stack(
                ...
                children: [
                  CarouselSlider(
                    ...
                    carouselController: _controllerCarouselSlider,
                  ...
                  Positioned(
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        _controllerCarouselSlider.previousPage(
                  ...
                  Positioned(
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        _controllerCarouselSlider.nextPage(
                          duration: const Duration(milliseconds: 300),
                          curve: Curves.easeInOut,
                        );
                      },
              ...
              Row(
                ...
                children:
                    images.asMap().entries.map((entry) {
                      return GestureDetector(
                        onTap:
                            () => _controllerCarouselSlider.animateToPage(
                              entry.key,
                            ),
                        child: Container(
                          width: 10,
